...
$stmt = $pdo->prepare("SELECT * FROM projets_portfolio WHERE categorie = 'hotelier' ORDER BY date_creation DESC");
$stmt->execute();
...
<head>
    ...
    <title>Design Hôtelier - Réalisations</title>
    ...
    <link rel="stylesheet" href="hotelier.css">
    <style>
...
<section class="hero-section">
    <div class="container">
        <h1 class="display-4 mb-4">Design Hôtelier d'Exception</h1>
        <p class="lead">Créez une expérience mémorable pour vos clients avec des espaces qui allient luxe, confort et identité distinctive</p>
    </div>
</section>

<section class="gallery-container">
    <div class="container">
        <!-- Barre de recherche et tri (optionnelle) -->
        ...
        <div class="row" id="projectsGrid">
            <?php if (empty($projets)): ?>
                <div class="col-12 text-center py-5">
                    <p>Aucune réalisation hôtelière pour le moment.</p>
                </div>
            <?php else: ?>
