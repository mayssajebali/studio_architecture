...
$stmt = $pdo->prepare("SELECT * FROM projets_portfolio WHERE categorie = 'commercial' ORDER BY date_creation DESC");
$stmt->execute();
...
<head>
    ...
    <title>Design Commercial - Réalisations</title>
...
<section class="hero-section">
    <div class="container">
        <h1 class="display-4 mb-4">Design Commercial d'Exception</h1>
        <p class="lead">Optimisez l'expérience client et augmentez votre chiffre d'affaires avec des espaces commerciaux attractifs et fonctionnels</p>
    </div>
</section>
        ...
        <div class="row" id="projectsGrid">
            <?php if (empty($projets)): ?>
                <div class="col-12 text-center py-5">
                    <p>Aucune réalisation commerciale pour le moment.</p>
                </div>
            <?php else: ?>
