...
$stmt = $pdo->prepare("SELECT * FROM projets_portfolio WHERE categorie = 'surMesure' ORDER BY date_creation DESC");
$stmt->execute();
...
<head>
    ...
    <title>Design Sur-Mesure - Réalisations</title>
    ...
    <link rel="stylesheet" href="surMesure.css">
    <style>
...
<section class="hero-section">
    <div class="container">
        <h1 class="display-4 mb-4">Design Sur-Mesure d'Exception</h1>
        <p class="lead">Des solutions créatives adaptées à vos besoins spécifiques pour tous types d'espaces et d'ambiances</p>
    </div>
</section>
        ...
        <div class="row" id="projectsGrid">
            <?php if (empty($projets)): ?>
                <div class="col-12 text-center py-5">
                    <p>Aucune réalisation sur mesure pour le moment.</p>
                </div>
            <?php else: ?>
                    ...
                    <div class="modal">
                        <div class="modal-content">
                            ...
                            <div class="project-info">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <h5>Concept Sur-Mesure</h5>
                                        <p><?= nl2br(htmlspecialchars($p['concept'])) ?></p>
                                    </div>
                                    <div class="col-md-6">
                                        <h5>Matériaux & Réalisation</h5>
