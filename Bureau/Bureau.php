...
$stmt = $pdo->prepare("SELECT * FROM projets_portfolio WHERE categorie = 'bureau' ORDER BY date_creation DESC");
$stmt->execute();
...
<head>
    ...
    <title>Design Bureaux - Réalisations</title>
...
<section class="hero-section">
    <div class="container">
        <h1 class="display-4 mb-4">Design de Bureaux d'Exception</h1>
        <p class="lead">Concevez des espaces de travail productifs, ergonomiques et inspirants qui favorisent le bien-être et la collaboration</p>
    </div>
</section>
        ...
        <div class="row" id="projectsGrid">
            <?php if (empty($projets)): ?>
                <div class="col-12 text-center py-5">
                    <p>Aucune réalisation de bureau pour le moment.</p>
                </div>
            <?php else: ?>
